...
export const BottomNav: React.FC = () => {
  return (
    <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 select-none">
      <div 
        className="flex items-center gap-4 bg-white rounded-full pl-4 pr-2 py-2 border border-[#F1F3F1]"
        style={{
      ...
      >
        ...
        <button 
          ...
          className="bg-[#2563EB] text-white text-xs font-semibold px-4 py-2 rounded-full hover:bg-blue-600 active:scale-95 transition-all shadow-sm shrink-0 cursor-pointer"
        >
          Book a call
        </button>
      </div>
